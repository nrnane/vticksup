                 ...
                 <div class="input-daterange" id="datepicker" >
                    <?php
                        ...
                        if(isset($searchData)){
						  ...
						  $curDate = $searchData['toDate'];
                          $twoWeeksBackDate = $searchData['fromDate'];
                        }

                    ?>
                     <input type="text" id="fromDate" class="input-small form-control pull-left" placeholder="From date" name="search[fromDate]" value="<?php echo $twoWeeksBackDate; ?>" style="width:48%" />

             <input type="text" id="toDate" class="input-small form-control pull-left" placeholder="To date" name="search[toDate]" value="<?php echo $curDate?>" style="width:48%" />
            </div>
            </div>
            <div class="col-sm-2">
