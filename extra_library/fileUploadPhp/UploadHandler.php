...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'upload_dir' => realpath(dirname($this->get_server_var('SCRIPT_FILENAME')).'/../..').'/uploads/',
            'upload_url' => $this->get_full_url_of_website().'/uploads/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
            ...
            'image_versions' => array(
                ...
                */
                'thumbnail' => array(
                    ...
                    'upload_url' => $this->get_full_url_of_website().'/small/',
    ...
    function get_full_url_of_website() {
        $https = !empty($_SERVER['HTTPS']) && strcasecmp($_SERVER['HTTPS'], 'on') === 0 ||
            !empty($_SERVER['HTTP_X_FORWARDED_PROTO']) &&
                strcasecmp($_SERVER['HTTP_X_FORWARDED_PROTO'], 'https') === 0;
        $url=
        ...
        return str_replace('/extra_library/fileUploadPhp','',$url);
    }
    ...
    protected function trim_file_name($file_path, $name, $size, $type, $error,
        ...
        return $this->generate_unique_filename($name);
    }
