                          ...
                          <div class="attachments">
                            ...
                            <?php foreach($attachements as $item){ 
                                ...
                                <a href="<?=base_url('uploads/'.$item['img_name'])?>" data-toggle="lightbox" class="pull-left" style="width:150px;height:150px; margin-right:5px;">
                                  <img src="<?=base_url('uploads/small/'.$item['img_name'])?>" width="150" height="150" alt="" />
                                </a>
                                <?php }else{
                          ...
                          <!--COnverjations start-->
                            ...
                            <div class="row" >
                              ...
                              <strong>
                                  ...
                                  (UID==$ts->uid)?'(You)':'';
                                  ?>
                                  </strong>&nbsp; <span class="text-muted">Replied  <?php echo $this->master_model->time_ago($ts->time);?> </span>
                              <br>
                            ...
                            if($ticket->status!=3){ ?>
                            <form id="create_edit_form" action="<?=site_url('home/view_ticket/'.$this->uri->segment(3))?>" method="POST"> </form>
